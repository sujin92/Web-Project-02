...
<meta charset="UTF-8">
<title>ChanggiFood-아이디 찾기</title>
</head>
<body>
	<section class="find_id d-flex align-items-center justify-content-center" style="width: 600px; height: 500px">
        <div class="container">
            <div class="mb-4 ml-4" style="position: absolute; top: 30px; left: 30px">
                <img src="../resources/images/logo_green.png" alt="" class="col-3">
            </div>
            <form action="idsearch.lo" method="post" name="idForm">
                <div class="mb-3">
                ...
                <div class="d-flex justify-content-center mt-5">
                    <input type="button" value="ID 찾기" class="btn btn-success col-4" onclick="idsearch()">
                </div>
            </form>
        </div>
     </section>
     <script type="text/javascript">
     	function  idsearch() {
     		...
     		if ((phone1.value == "" || phone2.value == "" || phone3.value == "") && mail.value == "") {
     			alert("휴대폰이나 이메일을 입력하신 후에 ID 찾기를 눌러주세요.");
     			return false;
     		}
