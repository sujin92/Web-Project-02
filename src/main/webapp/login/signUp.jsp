...
<meta charset="UTF-8">
<title>ChanggiFood-개인 고객 회원가입</title>
</head>
<body>
            ...
            <div>
                <form action="signup.lo" method="post" name="signForm" class="form-horizatal col-9">
                    ...
                    <div class="form-group row">
                        ...
                        <input name="pw" id="pw" type="password" placeholder="비밀번호(영문, 숫자, 특수문자 조합 8~20자리)" required class="form-control col-5" id="pw" onchange="success()">
                    </div>
                    <div class="form-group row">
                        <label class="col-3">비밀번호 확인 <span>*</span></label>
                        <input id="pwre" type="password" placeholder="비밀번호를 한 번 더 입력해주세요." required class="form-control col-5" id="pwre" onchange="success()">
                    </div>
                    <div class="pwans row">
                        <div class="col-3"></div>
                        <div class="col-5">
                    ...
                    <div class="form-group row">
                        <label class="col-3">이름 <span>*</span></label>
                        <input name="name" id="name" type="text" placeholder="이름을 입력해주세요." required class="form-control col-5">
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row birth">
                        <label class="col-3">생년월일</label>
                        <div class="col-6 row">
                            <input name="year" type="text" placeholder="YYYY" class="form-control col-3">
                            <input name="month" type="text" placeholder="MM" class="form-control col-3">
                            <input name="day" type="text" placeholder="DD" class="form-control col-3">
                        </div>
                    </div>
                    <div class="form-group row protocol">
                        ...
                        <div class="col-9 row">
                            ...
                            <div class="col-8">
                                <input type="checkbox" id="ch4" name="allcheck" class="allcheck" onclick="markettingAll(this)">
                    ...
                    <div class="form-group row submit">
                        <input type="button" value="가입하기" class="btn btn-secondary col-6" id="check" disabled onclick="validate()">
                    </div>
                </form>
            </div>
        </div>
